...
function App() {
  ...
  const questionPhotos=[
    {id:1,photoSrc:"/public/assets/backend-about1.png"},
    {id:2,photoSrc:"/public/assets/4-18.png"},
    {id:3,photoSrc:"/public/assets/19-35.png"},
    {id:4,photoSrc:"/public/assets/36-46.png"},
  ]
